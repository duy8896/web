...
<body data-spy="scroll" data-target=".navbar" data-offset="60">
	    	...
	    	<div class="panel panel-info">
	      		...
	      		<div class="panel-body" >
	        		<div id="signupform" class="form-horizontal" role="form">
            			<div style="margin-bottom: 25px;" class="input-group">
				            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
				            <input id="signup-id" type="text" class="form-control" value="" placeholder="Username nhiều hơn 5 ký tự và bắt đầu bằng chữ." required></input>
	          			</div>
			            <div style="margin-bottom: 25px;" class="input-group">
				            <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
				            <input id="signup-pw" type="password" class="form-control" value="" placeholder="Password nhiều hơn 8 ký tự." required></input>
		          		</div>
						<div class="form-group">
	...
	<script type="text/javascript">
		var image = document.querySelector('#bg-login');
	    ...
	    if (image.complete) datet();
	    else image.onload = datet;

	    function datet() {
	      document.addEventListener('mousemove', onMouseMove);
	      window.addEventListener('resize', resizeCanvases);
	      document.querySelector('#opacity-screen').appendChild(imageCanvas);
	      resizeCanvases();
	      tick();
	    }
	    ...
	    $.ajax({
	      ...
	      success : function(response){
	        if (response == "login success"){
	          ...
	          alert("Rất tiếc! Username hoặc Password không đúng yêu cầu.");
	          window.location="";
	        }
	      }
	    });
	    ...
	    $.ajax({
	      ...
	      success : function(response){
	        ...
	        if (response == "signup success"){
	          alert("Chúc mừng! Hãy đăng nhập và tận hưởng những bài hát mà bạn thích.");
	          window.location="";
	        }
