...
<html>
	...
	You need to change PHP's config in "php.ini"
	...
	<body>
		<section class="navbar">
		    <div class="container">
				...
				<?php
					if (isset($_SESSION['user'])){
						echo "<a id=\"goto-login\" href=\"logout.php\" title=\"Sign out\"><img src=\"picture/logout.png\"/></a>";
	    	...
	    	$.ajax({
				...
				success : function(response){
					...
					if (response == "buy success"){
					  alert("Bạn đã mua thành công! Xin mời thưởng thức.");
					  window.location="";
					}
					else if (response == "buy failure"){
					  alert("Rất tiếc! Có gì đó sai sai!");
					  window.location="";
					}
				}
			});
